...
const MOCK_RESPONSES = [
  `เสียใจที่ได้ยินแบบนั้นนะคะ หลังจากผ่าตัดแล้วคุณพ่อมีอาการอย่างไรบ้างคะ`,
  `เข้าใจค่ะ ฉันเสียใจที่คุณต้องเผชิญกับเหตุการณ์นี้ ฉันพร้อมช่วยเหลือคุณเต็มที่นะคะ
